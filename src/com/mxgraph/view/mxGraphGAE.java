...
public class mxGraphGAE extends mxGraph
{
	/**
	 ...
	 */
	public mxGraphGAE(mxIGraphModel model)
	{
		this(model, null);
	}
	 ...
	 */
	public mxGraphGAE(mxStylesheet stylesheet)
	{
	 ...
	 * @param model Model that contains the graph data
	 */
	public mxGraphGAE(mxIGraphModel model, mxStylesheet stylesheet)
	{
