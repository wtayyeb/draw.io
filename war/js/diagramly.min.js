...
b,c,d,e,f,i){if(null!=a&&null!=b){c=k;d=a;e=b;"#"==d.charAt(0)&&(d=d.substring(1));"#"==e.charAt(0)&&(e=e.substring(1));d=d.toLowerCase();e=e.toLowerCase();f=null;if(null==i||i==mxConstants.DIRECTION_SOUTH)f="s";else if(i==mxConstants.DIRECTION_EAST)f="e";else{var l=d,d=e,e=l;i==mxConstants.DIRECTION_NORTH?f="s":i==mxConstants.DIRECTION_WEST&&(f="e")}d=d+"-"+e+"-"+f;e=r[d];null==e&&(e=g("linearGradient"),e.setAttribute("id",++s),e.setAttribute("x1","0%"),e.setAttribute("y1","0%"),e.setAttribute("x2",
"0%"),e.setAttribute("y2","0%"),null==i||i==mxConstants.DIRECTION_SOUTH?e.setAttribute("y2","100%"):i==mxConstants.DIRECTION_EAST?e.setAttribute("x2","100%"):i==mxConstants.DIRECTION_NORTH?e.setAttribute("y1","100%"):i==mxConstants.DIRECTION_WEST&&e.setAttribute("x1","100%"),i=g("stop"),i.setAttribute("offset","0%"),i.setAttribute("style","stop-color:"+a),e.appendChild(i),i=g("stop"),i.setAttribute("offset","100%"),i.setAttribute("style","stop-color:"+b),e.appendChild(i),h.appendChild(e),r[d]=e);
...
h.insertBefore(m,h.firstChild.nextSibling):h.appendChild(m)}k.gradient="0"},rect:function(a,c,e,f){a+=k.dx;c+=k.dy;n=g("rect");n.setAttribute("x",q(a*k.scale));n.setAttribute("y",q(c*k.scale));n.setAttribute("width",q(e*k.scale));n.setAttribute("height",q(f*k.scale));!b&&d&&n.setAttribute("shape-rendering","crispEdges")},roundrect:function(a,c,e,f,h,i){a+=k.dx;c+=k.dy;n=g("rect");n.setAttribute("x",q(a*k.scale));n.setAttribute("y",q(c*k.scale));n.setAttribute("width",q(e*k.scale));n.setAttribute("height",
q(f*k.scale));0<h&&n.setAttribute("rx",q(h*k.scale));0<i&&n.setAttribute("ry",q(i*k.scale));!b&&d&&n.setAttribute("shape-rendering","crispEdges")},ellipse:function(a,b,c,d){a+=k.dx;b+=k.dy;n=g("ellipse");n.setAttribute("cx",q((a+c/2)*k.scale));n.setAttribute("cy",q((b+d/2)*k.scale));n.setAttribute("rx",q(c/2*k.scale));n.setAttribute("ry",q(d/2*k.scale))},image:function(b,d,e,f,h,i,l,m){var h=c.convert(h),i=null!=i?i:!0,l=null!=l?l:!1,m=null!=m?m:!1,b=b+k.dx,d=d+k.dy,n=g("image");n.setAttribute("x",
q(b*k.scale));n.setAttribute("y",q(d*k.scale));n.setAttribute("width",q(e*k.scale));n.setAttribute("height",q(f*k.scale));mxClient.IS_VML?n.setAttribute("xlink:href",h):n.setAttributeNS(mxConstants.NS_XLINK,"xlink:href",h);i||n.setAttribute("preserveAspectRatio","none");1>k.alpha&&n.setAttribute("opacity",k.alpha);h=k.transform;if(l||m){var r=i=1,o=0,w=0;l&&(i=-1,o=-e-2*b);m&&(r=-1,w=-f-2*d);h+="scale("+i+","+r+")translate("+o+","+w+")"}0<h.length&&n.setAttribute("transform",h);a.appendChild(n)},
text:function(c,d,h,i,l,m,n,r,o,w){if(e){c+=k.dx;d+=k.dy;if(f&&"html"==w)o=g("g"),o.setAttribute("transform",k.transform+"scale("+k.scale+","+k.scale+")"),1>k.alpha&&o.setAttribute("opacity",k.alpha),w=g("foreignObject"),w.setAttribute("x",Math.round(c)),w.setAttribute("y",Math.round(d)),w.setAttribute("width",Math.round(h)),w.setAttribute("height",Math.round(i)),w.appendChild(v(l,m,n)),o.appendChild(w);else{var w=Math.floor(k.fontSize),o=g("g"),p=k.transform;r&&(r=d+i/2,p+="rotate(-90,"+q((c+h/2)*
k.scale)+","+q(r*k.scale)+")");0<p.length&&o.setAttribute("transform",p);1>k.alpha&&o.setAttribute("opacity",k.alpha);m=m==mxConstants.ALIGN_RIGHT?"end":m==mxConstants.ALIGN_CENTER?"middle":"start";c="end"==m?c+Math.max(0,h-2):"middle"==m?c+h/2:c+(0<h?2:0);(k.fontStyle&mxConstants.FONT_BOLD)==mxConstants.FONT_BOLD&&o.setAttribute("font-weight","bold");(k.fontStyle&mxConstants.FONT_ITALIC)==mxConstants.FONT_ITALIC&&o.setAttribute("font-style","italic");(k.fontStyle&mxConstants.FONT_UNDERLINE)==mxConstants.FONT_UNDERLINE&&
o.setAttribute("text-decoration","underline");"start"!=m&&o.setAttribute("text-anchor",m);(!b||w!=mxConstants.DEFAULT_FONTSIZE)&&o.setAttribute("font-size",Math.floor(w*k.scale)+"px");(!b||k.fontFamily!=mxConstants.DEFAULT_FONTFAMILY)&&o.setAttribute("font-family",k.fontFamily);o.setAttribute("fill",k.fontColor);h=l.split("\n");l=1.25*w;m=i-(0<i?w+(h.length-1)*l:h.length*l-1);null==n||n==mxConstants.ALIGN_TOP?d=Math.max(d-3*k.scale,d+m/2+(0<i?l/2-8:0)):n==mxConstants.ALIGN_MIDDLE?d+=m/2:n==mxConstants.ALIGN_BOTTOM&&
(d=Math.min(d,d+m+2*k.scale));d+=w;for(i=0;i<h.length;i++)n=g("text"),n.setAttribute("x",q(c*k.scale)),n.setAttribute("y",q(d*k.scale)),mxUtils.write(n,h[i]),o.appendChild(n),d+=1.3*w}a.appendChild(o)}},begin:function(){n=g("path");o=[];p=null;l=!0},moveTo:function(a,b){null!=o&&(a+=k.dx,b+=k.dy,o.push("M "+q(a*k.scale)+" "+q(b*k.scale)),d&&(p=new mxPoint(a,b)))},lineTo:function(a,b){null!=o&&(a+=k.dx,b+=k.dy,o.push("L "+q(a*k.scale)+" "+q(b*k.scale)),d&&(null!=p&&l&&(a!=p.x&&b!=p.y)&&(l=!1),p=new mxPoint(a,
b)))},quadTo:function(a,b,c,d){null!=o&&(a+=k.dx,b+=k.dy,c+=k.dx,d+=k.dy,o.push("Q "+q(a*k.scale)+" "+q(b*k.scale)+" "+q(c*k.scale)+" "+q(d*k.scale)),l=!1)},curveTo:function(a,b,c,d,e,f){null!=o&&(a+=k.dx,b+=k.dy,c+=k.dx,d+=k.dy,e+=k.dx,f+=k.dy,o.push("C "+q(a*k.scale)+" "+q(b*k.scale)+" "+q(c*k.scale)+" "+q(d*k.scale)+" "+q(e*k.scale)+" "+q(f*k.scale)),l=!1)},close:function(){null!=o&&o.push("Z")},stroke:function(){w(n,k,!1,!0)},fill:function(){w(n,k,!0,!1)},fillAndStroke:function(){w(n,k,!0,!0)},
...
l=document.createElement("td");l.style.fontSize="10pt";mxUtils.write(l,mxResources.get("backgroundColor")+":");g.appendChild(l);var p=document.createElement("input");p.setAttribute("value",f.background||"#FFFFFF");p.style.width="80px";var r=document.createElement("input");r.setAttribute("type","checkbox");l=document.createElement("td");l.appendChild(p);l.appendChild(r);mxUtils.write(l,mxResources.get("transparent"));g.appendChild(l);m.appendChild(g);g=document.createElement("tr");l=document.createElement("td");
l.style.fontSize="10pt";mxUtils.write(l,mxResources.get("width")+":");g.appendChild(l);var s=document.createElement("input");s.setAttribute("value",i);s.style.width="180px";l=document.createElement("td");l.appendChild(s);g.appendChild(l);m.appendChild(g);g=document.createElement("tr");l=document.createElement("td");l.style.fontSize="10pt";mxUtils.write(l,mxResources.get("height")+":");g.appendChild(l);var u=document.createElement("input");u.setAttribute("value",k);u.style.width="180px";l=document.createElement("td");
...
q.scale(l);q.translate(Math.floor(-m.x*l)+h,Math.floor(-m.y*l)+h);w.drawState(f.getView().getState(f.model.root),q);q=Math.ceil(m.width*l)+2*h;h=Math.ceil(m.height*l)+2*h;g=mxUtils.getXml(g);if(g.length<=MAX_REQUEST_SIZE&&i<MAX_WIDTH&&0<i&&k<MAX_HEIGHT&&0<k){l="";if(""!=p.value&&p.value!=mxConstants.NONE&&("png"!=b||!r.checked))l="&bg="+p.value;(new mxXmlRequest(EXPORT_URL,"filename="+c+"&format="+b+l+"&w="+q+"&h="+h+"&plain="+encodeURIComponent(g))).simulate(document,"_blank")}else mxUtils.alert(mxResources.get("drawingTooLarge"))}a.hideDialog()}}));
l.appendChild(q);l.appendChild(mxUtils.button(mxResources.get("cancel"),function(){a.hideDialog()}));g.appendChild(l);m.appendChild(g);var t=null;mxEvent.addListener(o,"change",function(){var b=o.value;"xml"==b?null==t?t=a.replaceSaveButton(q,e,mxUtils.bind(this,function(){return n.value}),mxUtils.bind(this,function(){a.hideDialog()})):null!=t&&"none"==t.style.display&&(t.style.display="inline"):"svg"==b?null==t?t=a.replaceSaveButton(q,d,mxUtils.bind(this,function(){return n.value}),mxUtils.bind(this,
function(){a.hideDialog()})):null!=t&&"none"==t.style.display&&(t.style.display="inline"):null!=t&&"none"!=t.style.display&&(t.style.display="none")});m.appendChild(g);h.appendChild(m);this.container=h}
...
"F1"));this.editorUi.actions.put("didYouKnow",new Action(mxResources.get("didYouKnow"),mxUtils.bind(this,function(){window.open("http://forum.jgraph.com/questions/4162")})));this.editorUi.actions.put("help",new Action(mxResources.get("forum"),mxUtils.bind(this,function(){window.open("http://forum.jgraph.com/")})));this.editorUi.actions.put("github",new Action("Fork me on GitHub",mxUtils.bind(this,function(){window.open("https://github.com/jgraph/draw.io")})));this.editorUi.actions.addAction("image",
...
a.scrollCellToVisible(f[0])}}if(typeof google!="undefined"&&typeof google.picker!="undefined"){var c=(new google.picker.PickerBuilder).addView(google.picker.ViewId.IMAGE_SEARCH);if(driveDomain||urlParams.picker=="2"){var d=new google.picker.View(google.picker.ViewId.DOCS);d.setMimeTypes("image/png,image/jpeg,image/jpg");c.addView(d);c.addView(google.picker.ViewId.PHOTO_UPLOAD);c.addView(google.picker.ViewId.PHOTOS)}else c.enableFeature(google.picker.Feature.NAV_HIDDEN);c.setCallback(function(a){if(a.action==
google.picker.Action.PICKED){for(var c=a.docs[0].thumbnails[0],d=0;c.width<100&&c.height<100&&a.docs[0].thumbnails.length>d+1;)c=a.docs[0].thumbnails[++d];c!=null&&b(c.url,Number(c.width),Number(c.height))}}).build().setVisible(true)}else{var e="",c=a.getView().getState(a.getSelectionCell());c!=null&&(e=c.style[mxConstants.STYLE_IMAGE]||e);e=mxUtils.prompt(mxResources.get("enterValue")+" ("+mxResources.get("url")+")",e);if(e!=null&&e.length>0){var f=new Image;f.onload=function(){b(e,f.width,f.height)};
f.onerror=function(){mxUtils.alert(mxResources.get("fileNotFound"))};f.src=e}}});this.put("help",new Menu(mxUtils.bind(this,function(b,c){this.addMenuItems(b,["didYouKnow","help","-","github","-","about"]);if(urlParams.test=="1"){if(typeof jsCanvas!="undefined"){mxResources.parse("pngExport=PNG Export (Local)");this.editorUi.actions.addAction("pngExport",mxUtils.bind(this,function(){var a=this.editorUi.editor.graph.getGraphBounds(),b=document.createElement("canvas");b.setAttribute("width",Math.ceil(a.width*
1));b.setAttribute("height",Math.ceil(a.height*1));var c=new jsCanvas(b);c.scale(1);c.translate(-a.x,-a.y);(new mxImageExport).drawState(this.editorUi.editor.graph.getView().getState(this.editorUi.editor.graph.model.root),c);c.finish(mxUtils.bind(this,function(){document.body.appendChild(b);b.style.border="1px solid gray";this.editorUi.showDialog(b,640,480,true,true);this.editorUi.dialog.container.style.overflow="auto"}))}));this.addMenuItems(b,["-","pngExport"],c)}if(typeof jsPDF!="undefined"){mxResources.parse("pdfExport=PDF Export (Local)");
this.editorUi.actions.addAction("pdfExport",mxUtils.bind(this,function(){var a=new jsPDF;a.scale(1/this.editorUi.editor.graph.pageScale);(new mxImageExport).drawState(this.editorUi.editor.graph.getView().getState(this.editorUi.editor.graph.model.root),a);a.setProperties({title:this.editorUi.editor.getFilename(),creator:"Diagram.ly"});var b=window.open("about:blank");a.finish(function(){var c=a.output();b.location.href="data:application/pdf;base64,"+Base64.encode(c,true)})}));this.addMenuItems(b,["pdfExport"],
c)}mxResources.parse("hierarchicalVertical=Hierarchical (Vertical)");mxResources.parse("hierarchicalHorizontal=Hierarchical (Horizontal)");this.editorUi.actions.addAction("hierarchicalVertical",mxUtils.bind(this,function(){this.editorUi.executeLayout(new mxHierarchicalLayout(a,mxConstants.DIRECTION_NORTH),true,true)}));this.editorUi.actions.addAction("hierarchicalHorizontal",mxUtils.bind(this,function(){this.editorUi.executeLayout(new mxHierarchicalLayout(a,mxConstants.DIRECTION_WEST),true,true)}));
this.addMenuItems(b,["-","hierarchicalVertical","hierarchicalHorizontal"],c);mxResources.parse("snapshot=Snapshot");mxResources.parse("debug=Debug");this.editorUi.actions.addAction("snapshot",mxUtils.bind(this,function(){this.editorUi.sharing!=null&&console.log(this.editorUi.sharing.doc)}));this.editorUi.actions.addAction("debug",mxUtils.bind(this,function(){if(this.editorUi.sharing!=null){this.editorUi.sharing.logging=!this.editorUi.sharing.logging;this.editorUi.sharing.logging&&mxLog.show();mxLog.debug("Debugging "+
(this.editorUi.sharing.logging?"enabled":"disabled"))}else mxLog.debug("Document not shared")}));this.addMenuItems(b,["-","snapshot","debug"],c);mxResources.parse("showConsole=Show Console");this.editorUi.actions.addAction("showConsole",function(){mxLog.show()});this.addMenuItems(b,["-","showConsole"])}})));this.put("new",new Menu(mxUtils.bind(this,function(a,b){this.addMenuItems(a,["new","newCopy","-","fromTemplate","fromText"],b);driveDomain||this.addMenuItems(a,["-","newGoogleDrive"],b)})));this.editorUi.actions.addAction("embed",
mxUtils.bind(this,function(){this.editorUi.showDialog((new EmbedDialog(this.editorUi)).container,620,420,true,true)}));this.put("file",new Menu(mxUtils.bind(this,function(a,b){this.addSubmenu("new",a,b);this.addMenuItems(a,["open","-","save","saveAs","-","export","share","embed","-","import","editFile","-","pageSetup","print"],b)})))};EditorUi.prototype.replaceSaveButton=function(a,b,c,d){var e=null,f=window;f.URL=f.webkitURL||f.URL;f.BlobBuilder=f.BlobBuilder||f.WebKitBlobBuilder||f.MozBlobBuilder;
"undefined"!=typeof swfobject&&(swfobject.hasFlashPlayerVersion("10")&&"undefined"!=typeof Downloadify)&&(e=document.createElement("span"),a.parentNode.insertBefore(e,a),Downloadify.create(e,{data:b,filename:c,onComplete:d,onCancel:function(){},onError:function(){},swf:"/js/downloadify/downloadify.swf",downloadImage:"/js/downloadify/transparent.png",width:a.offsetWidth+2,height:a.offsetHeight+2,transparent:!0,append:!0}),b="-6px",mxClient.IS_IE&&9==document.documentMode?b="-7px":mxClient.IS_IE&&(b=
"-3px"),e.style.display="inline",e.style.position="absolute",e.style.left=a.offsetLeft+20+"px",e.style.height=a.offsetHeight+2+"px",e.style.width=a.offsetWidth+2+"px",e.firstChild.style.marginBottom=b,mxEvent.addListener(e,"mouseover",function(){a.focus()}),mxEvent.addListener(e,"mouseout",function(){a.blur()}));return e};useLocalStorage||(EditorUi.prototype.saveFile=function(a){!a&&null!=this.editor.filename?this.save(this.editor.getOrCreateFilename()):this.showDialog((new SaveDialog(this)).container,
300,driveDomain?150:80,!0,!0);if(null!=this.dialog){var a=mxUtils.bind(this,function(a){for(var a=document.getElementsByTagName(a),b=0;b<a.length;b++)for(var c=a[b].parentNode;null!=c;){if(c==this.dialog.container)return a[b];c=c.parentNode}return null}),b=a("input"),a=a("button");null!=b&&null!=a&&this.replaceSaveButton(a,mxUtils.bind(this,function(){return mxUtils.getXml(this.editor.getGraphXml())}),mxUtils.bind(this,function(){return b.value}),mxUtils.bind(this,function(){this.editor.filename=
b.value;this.editor.modified=!1;this.hideDialog()}))}});var n=Graph.prototype.loadStylesheet;Graph.prototype.loadStylesheet=function(){n.apply(this,arguments);this.currentStyle="default-style2"};var o=Editor.prototype.setGraphXml;Editor.prototype.setGraphXml=function(a){if(a.nodeName=="mxGraphModel"){var b=a.getAttribute("style");if(b==null||b==""){var c=mxUtils.load(STYLE_PATH+"/default-old.xml").getDocumentElement(),d=new mxCodec(c.ownerDocument);d.decode(c,this.graph.getStylesheet())}else if(b!=
this.graph.currentStyle){c=mxUtils.load(STYLE_PATH+"/"+b+".xml").getDocumentElement();d=new mxCodec(c.ownerDocument);d.decode(c,this.graph.getStylesheet());this.graph.currentStyle=b}this.graph.currentStyle=b}o.apply(this,arguments)};var p=Editor.prototype.getGraphXml;Editor.prototype.getGraphXml=function(){var a=p.apply(this,arguments);this.graph.currentStyle!=null&&a.setAttribute("style",this.graph.currentStyle);return a}})();(function(a,b){a.version="0.8.7";a.protocol=1;a.transports=[];a.j=[];a.sockets={};a.connect=function(c,d){var e=a.util.parseUri(c),f,g;b&&b.location&&(e.protocol=e.protocol||b.location.protocol.slice(0,-1),e.host=e.host||(b.document?b.document.domain:b.location.hostname),e.port=e.port||b.location.port);f=a.util.uniqueUri(e);var h={host:e.host,secure:"https"==e.protocol,port:e.port||("https"==e.protocol?443:80),query:e.query||""};a.util.merge(h,d);if(h["force new connection"]||!a.sockets[f])g=new a.Socket(h);
