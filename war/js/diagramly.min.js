...
b,c,d,e,f,i){if(null!=a&&null!=b){c=k;d=a;e=b;"#"==d.charAt(0)&&(d=d.substring(1));"#"==e.charAt(0)&&(e=e.substring(1));d=d.toLowerCase();e=e.toLowerCase();f=null;if(null==i||i==mxConstants.DIRECTION_SOUTH)f="s";else if(i==mxConstants.DIRECTION_EAST)f="e";else{var m=d,d=e,e=m;i==mxConstants.DIRECTION_NORTH?f="s":i==mxConstants.DIRECTION_WEST&&(f="e")}d=d+"-"+e+"-"+f;e=q[d];null==e&&(e=g("linearGradient"),e.setAttribute("id",++s),e.setAttribute("x1","0%"),e.setAttribute("y1","0%"),e.setAttribute("x2",
...
(new mxXmlRequest(SAVE_URL,"filename="+c+"&xml="+g)).simulate(document,"_blank")}else if("svg"==b)g=d(),g.length<MAX_REQUEST_SIZE?(g=encodeURIComponent(g),(new mxXmlRequest(SAVE_URL,"filename="+c+"&format="+b+"&xml="+g)).simulate(document,"_blank")):(mxUtils.alert(mxResources.get("drawingTooLarge")),mxUtils.popup(g));else{var h=Math.max(0,parseInt(v.value))+1,m=parseInt(s.value)/i,l=f.getGraphBounds(),r=mxUtils.createXmlDocument(),g=r.createElement("output");r.appendChild(g);r=new mxXmlCanvas2D(g);
...
i=h.width>0?h.x/this.view.scale-this.view.translate.x:0,h=h.height>0?h.y/this.view.scale-this.view.translate.y:0,f=this.pageFormat,g=this.pageScale,k=f.width*g,f=f.height*g,i=Math.floor(Math.min(0,i)/k),h=Math.floor(Math.min(0,h)/f);return new mxRectangle((d-i)*c.width+2,(e-h)*c.height+2)};var s=this.editor.outline.getSourceContainerSize;this.editor.outline.getSourceContainerSize=function(){if(p.scrollbars&&!touchStyle){var a=this.source.view.scale;return new mxRectangle(0,0,this.source.container.scrollWidth-
1600*a,this.source.container.scrollHeight-1600*a)}return s.apply(this,arguments)};this.editor.outline.getOutlineOffset=function(a){if(p.scrollbars&&!touchStyle){var b=this.source.pageFormat,c=this.source.pageScale;return new mxPoint(-800+(this.outline.container.clientWidth/a-b.width*c)/2,-800+(this.outline.container.clientHeight/a-b.height*c)/2)}return null};p.sizeDidChange();var t=[new mxCell("",new mxGeometry(0,0,0,0),"endArrow=none")];t[0].edge=!0;p.connectionHandler.createEdgeState=function(){return p.view.createState(t[0])};
p.connectionHandler.factoryMethod=function(){return p.cloneCells([t[0]])[0]};this.actions.get("pageView").funct();var v=this;driveDomain&&(a=document.createElement("div"),a.style.padding="4px 12px 5px 10px",a.style.cssFloat="right",a.style.styleFloat="right",c=document.createElement("span"),c.style.display="none",c.style.cssFloat="left",c.style.styleFloat="left",c.style.padding="0px 8px 5px 10px",c.style.fontStyle="italic",d=document.createElement("a"),d.className="geItem",d.style.cssFloat="left",
