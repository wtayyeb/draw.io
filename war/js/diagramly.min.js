...
Math.PI/180),e=m*k+n*l,k=-1*n*k+m*l,l=e*e,o=k*k,p=c*c,q=d*d,s=l/p+o/q;1<s?(c*=Math.sqrt(s),d*=Math.sqrt(s),f=0):(s=1,f===g&&(s=-1),f=s*Math.sqrt((p*q-p*o-q*l)/(p*o+q*l)));l=f*c*k/d;o=-1*f*d*e/c;h=m*l-n*o+h/2;i=n*l+m*o+i/2;p=Math.atan2((k-o)/d,(e-l)/c)-Math.atan2(0,1);f=0<=p?p:2*Math.PI+p;p=Math.atan2((-k-o)/d,(-e-l)/c)-Math.atan2((k-o)/d,(e-l)/c);e=0<=p?p:2*Math.PI+p;0==g&&0<e?e-=2*Math.PI:0!=g&&0>e&&(e+=2*Math.PI);for(var g=2*e/Math.PI,g=Math.ceil(0>g?-1*g:g),e=e/g,k=8/3*Math.sin(e/4)*Math.sin(e/
4)/Math.sin(e/2),l=m*c,m=m*d,c=n*c,d=n*d,t=Math.cos(f),v=Math.sin(f),o=-k*(l*v+d*t),p=-k*(c*v-m*t),n=[],w=0;w<g;++w){var f=f+e,t=Math.cos(f),v=Math.sin(f),q=l*t-d*v+h,s=c*t+m*v+i,r=-k*(l*v+d*t),t=-k*(c*v-m*t),v=6*w;n[v]=Number(o+a);n[v+1]=Number(p+b);n[v+2]=Number(q-r+a);n[v+3]=Number(s-t+b);n[v+4]=Number(q+a);n[v+5]=Number(s+b);o=q+r;p=s+t}return n},getBoundingBox:function(a,b){var c=null;if(null!=a&&null!=b&&0!=b){var d=mxUtils.toRadians(b),c=Math.cos(d),e=Math.sin(d),f=new mxPoint(a.x+a.width/
...
c.y);b.stroke();return!0}}};this.shapes.arrow={drawShape:function(a,c,d,e){if(e){var d=mxConstants.ARROW_SPACING,f=mxConstants.ARROW_WIDTH,e=mxConstants.ARROW_SIZE,c=c.absolutePoints,g=c[0],c=c[c.length-1],h=c.x-g.x,i=c.y-g.y,k=Math.sqrt(h*h+i*i),l=k-2*d-e,e=h/k,i=i/k,k=f*i/3,f=-f*e/3,h=g.x-k/2+d*e,g=g.y-f/2+d*i,m=h+k,n=g+f,o=m+l*e,l=n+l*i,p=o+k,q=l+f,s=p-3*k,t=q-3*f;a.begin();a.moveTo(h,g);a.lineTo(m,n);a.lineTo(o,l);a.lineTo(p,q);a.lineTo(c.x-d*e,c.y-d*i);a.lineTo(s,t);a.lineTo(s+k,t+f);a.close();
...
h(o));a.appendChild(p)},ellipse:function(b,c,d,f){var g=e.createElement("ellipse");g.setAttribute("x",h(b));g.setAttribute("y",h(c));g.setAttribute("w",h(d));g.setAttribute("h",h(f));a.appendChild(g)},image:function(c,d,f,g,n,o,p,q){var n=b.convert(n),s=e.createElement("image");s.setAttribute("x",h(c));s.setAttribute("y",h(d));s.setAttribute("w",h(f));s.setAttribute("h",h(g));s.setAttribute("src",n);s.setAttribute("aspect",o?"1":"0");s.setAttribute("flipH",p?"1":"0");s.setAttribute("flipV",q?"1":
"0");a.appendChild(s)},text:function(b,c,f,g,n,o,p,q,s,t){if(d){var v=e.createElement("text");v.setAttribute("x",h(b));v.setAttribute("y",h(c));v.setAttribute("w",h(f));v.setAttribute("h",h(g));v.setAttribute("str",n);null!=o&&v.setAttribute("align",o);null!=p&&v.setAttribute("valign",p);v.setAttribute("vertical",q?"1":"0");v.setAttribute("wrap",s?"1":"0");v.setAttribute("format",t);a.appendChild(v)}},begin:function(){a.appendChild(e.createElement("begin"))},moveTo:function(b,c){var d=e.createElement("move");
...
b,c,d,e,f,i){if(null!=a&&null!=b){c=k;d=a;e=b;"#"==d.charAt(0)&&(d=d.substring(1));"#"==e.charAt(0)&&(e=e.substring(1));d=d.toLowerCase();e=e.toLowerCase();f=null;if(null==i||i==mxConstants.DIRECTION_SOUTH)f="s";else if(i==mxConstants.DIRECTION_EAST)f="e";else{var l=d,d=e,e=l;i==mxConstants.DIRECTION_NORTH?f="s":i==mxConstants.DIRECTION_WEST&&(f="e")}d=d+"-"+e+"-"+f;e=q[d];null==e&&(e=g("linearGradient"),e.setAttribute("id",++s),e.setAttribute("x1","0%"),e.setAttribute("y1","0%"),e.setAttribute("x2",
...
r(b*k.scale));n.setAttribute("y",r(d*k.scale));n.setAttribute("width",r(e*k.scale));n.setAttribute("height",r(f*k.scale));mxClient.IS_VML?n.setAttribute("xlink:href",h):n.setAttributeNS(mxConstants.NS_XLINK,"xlink:href",h);i||n.setAttribute("preserveAspectRatio","none");1>k.alpha&&n.setAttribute("opacity",k.alpha);h=k.transform;if(l||m){var q=i=1,o=0,v=0;l&&(i=-1,o=-e-2*b);m&&(q=-1,v=-f-2*d);h+="scale("+i+","+q+")translate("+o+","+v+")"}0<h.length&&n.setAttribute("transform",h);a.appendChild(n)},
text:function(c,d,h,i,l,m,n,q,o,w){if(e){c+=k.dx;d+=k.dy;if(f&&"html"==w)o=g("g"),o.setAttribute("transform",k.transform+"scale("+k.scale+","+k.scale+")"),1>k.alpha&&o.setAttribute("opacity",k.alpha),w=g("foreignObject"),w.setAttribute("x",Math.round(c)),w.setAttribute("y",Math.round(d)),w.setAttribute("width",Math.round(h)),w.setAttribute("height",Math.round(i)),w.appendChild(v(l,m,n)),o.appendChild(w);else{var w=Math.floor(k.fontSize),o=g("g"),p=k.transform;q&&(q=d+i/2,p+="rotate(-90,"+r((c+h/2)*
k.scale)+","+r(q*k.scale)+")");0<p.length&&o.setAttribute("transform",p);1>k.alpha&&o.setAttribute("opacity",k.alpha);m=m==mxConstants.ALIGN_RIGHT?"end":m==mxConstants.ALIGN_CENTER?"middle":"start";c="end"==m?c+Math.max(0,h-2):"middle"==m?c+h/2:c+(0<h?2:0);(k.fontStyle&mxConstants.FONT_BOLD)==mxConstants.FONT_BOLD&&o.setAttribute("font-weight","bold");(k.fontStyle&mxConstants.FONT_ITALIC)==mxConstants.FONT_ITALIC&&o.setAttribute("font-style","italic");(k.fontStyle&mxConstants.FONT_UNDERLINE)==mxConstants.FONT_UNDERLINE&&
...
[new mxPoint(b,-this.graph.panDy),new mxPoint(b,d.scrollHeight-3-this.graph.panDy)]}h=h||c},k=function(b){var b=b+this.graph.panDy,c=!1;Math.abs(b-t)<m?(g=b-a.getCenterY(),m=Math.abs(b-t),c=!0):Math.abs(b-q)<m?(g=b-a.y,m=Math.abs(b-q),c=!0):Math.abs(b-s)<m&&(g=b-a.y-a.height,m=Math.abs(b-s),c=!0);if(c){null==this.guideY&&(this.guideY=this.createGuideShape(!1),this.guideY.dialect=this.graph.dialect!=mxConstants.DIALECT_SVG?mxConstants.DIALECT_VML:mxConstants.DIALECT_SVG,this.guideY.init(this.graph.getView().getOverlayPane()),
...
g}else{if(i||k){var m=1,n=1,o=0,p=0;i&&(m=-1,o=-b.width-2*b.x);k&&(n=-1,p=-b.height-2*b.y);l="scale("+m+" "+n+") translate("+o+" "+p+")"}0!=g&&(i=b.getCenterX(),k=b.getCenterY(),l+=" rotate("+g+" "+i+" "+k+")")}var q=null==d;if(null!=this.bgNode||null!=this.fgNode){var s=e&&null==d?0:b.x,t=e&&null==d?0:b.y,m=b.width/this.w0,n=b.height/this.h0;this.lastMoveY=this.lastMoveX=0;h&&(n=b.width/this.h0,m=b.height/this.w0,g=(b.width-b.height)/2,s+=g,t-=g);"fixed"==this.aspect&&(m=n=Math.min(m,n),h?(s+=(b.height-
this.w0*m)/2,t+=(b.width-this.h0*n)/2):(s+=(b.width-this.w0*m)/2,t+=(b.height-this.h0*n)/2));e&&(m*=f,n*=f,s*=f,t*=f);var v=Math.min(m,n),w=[],r=null!=d?d:{fillColorAssigned:!1,fill:a.fill,stroke:a.stroke,strokeWidth:"inherit"==this.strokewidth?Number(a.strokewidth)*a.scale:Number(this.strokewidth)*v/(e?f:1),dashed:a.isDashed,dashpattern:[3,3],alpha:a.opacity,linejoin:"miter",fontColor:"#000000",fontSize:mxConstants.DEFAULT_FONTSIZE,fontFamily:mxConstants.DEFAULT_FONTFAMILY,fontStyle:0},u=null,x=
...
null&&b.setAttribute("stroke",c.stroke)}},z=function(a){u!=null&&x!=null&&x.push(a)},y=function(a){return e?Math.round(a):a},C=function(d){var g=d.nodeName,h=g=="fill",i=g=="stroke",k=g=="fillstroke";if(g=="save"){w.push(r);r=mxUtils.clone(r)}else if(g=="restore")r=w.pop();else if(g=="path"){x=[];if(e){u=document.createElement("v:shape");A.call(this,u,r);k=Math.round(b.width)*f;g=Math.round(b.height)*f;u.style.width=k+"px";u.style.height=g+"px";u.coordsize=k+","+g}else{u=document.createElementNS(mxConstants.NS_SVG,
"path");A.call(this,u,r);l.length>0&&u.setAttribute("transform",l);d.getAttribute("crisp")=="1"&&u.setAttribute("shape-rendering","crispEdges")}for(d=d.firstChild;d!=null;){d.nodeType==mxConstants.NODETYPE_ELEMENT&&C.call(this,d);d=d.nextSibling}if(e){z("e");u.path=x.join("")}else u.setAttribute("d",x.join(""))}else if(g=="move"){h=e?"m":"M";this.lastMoveX=y(s+Number(d.getAttribute("x"))*m);this.lastMoveY=y(t+Number(d.getAttribute("y"))*n);z(h+" "+this.lastMoveX+" "+this.lastMoveY)}else if(g=="line"){h=
e?"l":"L";this.lastMoveX=y(s+Number(d.getAttribute("x"))*m);this.lastMoveY=y(t+Number(d.getAttribute("y"))*n);z(h+" "+this.lastMoveX+" "+this.lastMoveY)}else if(g=="quad")if(e){var h=this.lastMoveX,o=this.lastMoveY,i=s+Number(d.getAttribute("x1"))*m,g=t+Number(d.getAttribute("y1"))*n,k=s+Number(d.getAttribute("x2"))*m,d=t+Number(d.getAttribute("y2"))*n,o=o+2/3*(g-o),p=k+2/3*(i-k),g=d+2/3*(g-d);z("c "+Math.round(h+2/3*(i-h))+" "+Math.round(o)+" "+Math.round(p)+" "+Math.round(g)+" "+Math.round(k)+" "+
Math.round(d));this.lastMoveX=k;this.lastMoveY=d}else{this.lastMoveX=s+Number(d.getAttribute("x2"))*m;this.lastMoveY=t+Number(d.getAttribute("y2"))*n;z("Q "+(s+Number(d.getAttribute("x1"))*m)+" "+(t+Number(d.getAttribute("y1"))*n)+" "+this.lastMoveX+" "+this.lastMoveY)}else if(g=="curve"){h=e?"c":"C";this.lastMoveX=y(s+Number(d.getAttribute("x3"))*m);this.lastMoveY=y(t+Number(d.getAttribute("y3"))*n);z(h+" "+y(s+Number(d.getAttribute("x1"))*m)+" "+y(t+Number(d.getAttribute("y1"))*n)+" "+y(s+Number(d.getAttribute("x2"))*
m)+" "+y(t+Number(d.getAttribute("y2"))*n)+" "+this.lastMoveX+" "+this.lastMoveY)}else if(g=="close")z(e?"x":"Z");else if(g=="rect"||g=="roundrect"){o=g=="roundrect";i=y(s+Number(d.getAttribute("x"))*m);h=y(t+Number(d.getAttribute("y"))*n);k=y(Number(d.getAttribute("w"))*m);g=y(Number(d.getAttribute("h"))*n);p=d.getAttribute("arcsize");p==0&&(p=mxConstants.RECTANGLE_ROUNDING_FACTOR*100);if(e){u=document.createElement(o?"v:roundrect":"v:rect");u.style.left=i+"px";u.style.top=h+"px";u.style.width=k+
"px";u.style.height=g+"px";o&&u.setAttribute("arcsize",""+p+"%")}else{u=document.createElementNS(mxConstants.NS_SVG,"rect");u.setAttribute("x",i);u.setAttribute("y",h);u.setAttribute("width",k);u.setAttribute("height",g);if(o){h=Number(p)/100;h=Math.min(k*h,g*h);u.setAttribute("rx",h);u.setAttribute("ry",h)}l.length>0&&u.setAttribute("transform",l);d.getAttribute("crisp")=="1"&&u.setAttribute("shape-rendering","crispEdges")}A.call(this,u,r)}else if(g=="ellipse"){i=y(s+Number(d.getAttribute("x"))*
m);h=y(t+Number(d.getAttribute("y"))*n);k=y(Number(d.getAttribute("w"))*m);g=y(Number(d.getAttribute("h"))*n);if(e){u=document.createElement("v:arc");u.startangle="0";u.endangle="360";u.style.left=i+"px";u.style.top=h+"px";u.style.width=k+"px";u.style.height=g+"px"}else{u=document.createElementNS(mxConstants.NS_SVG,"ellipse");u.setAttribute("cx",i+k/2);u.setAttribute("cy",h+g/2);u.setAttribute("rx",k/2);u.setAttribute("ry",g/2);l.length>0&&u.setAttribute("transform",l)}A.call(this,u,r)}else if(g==
"arc"){var k=Number(d.getAttribute("rx"))*m,g=Number(d.getAttribute("ry"))*n,o=Number(d.getAttribute("x-axis-rotation")),p=Number(d.getAttribute("large-arc-flag")),B=Number(d.getAttribute("sweep-flag")),i=s+Number(d.getAttribute("x"))*m,h=t+Number(d.getAttribute("y"))*n;if(e){h=mxUtils.arcToCurves(this.lastMoveX,this.lastMoveY,k,g,o,p,B,i,h);for(d=0;d<h.length;d=d+6){z("c "+Math.round(h[d])+" "+Math.round(h[d+1])+" "+Math.round(h[d+2])+" "+Math.round(h[d+3])+" "+Math.round(h[d+4])+" "+Math.round(h[d+
5]));this.lastMoveX=h[d+4];this.lastMoveY=h[d+5]}}else{z("A "+k+","+g+" "+o+" "+p+","+B+" "+i+","+h);this.lastMoveX=s+i;this.lastMoveY=t+h}}else if(g=="image"){o=this.evaluateAttribute(d,"src",a.state);if(o!=null){i=y(s+Number(d.getAttribute("x"))*m);h=y(t+Number(d.getAttribute("y"))*n);k=y(Number(d.getAttribute("w"))*m);g=y(Number(d.getAttribute("h"))*n);p=d.getAttribute("flipH")=="1";B=d.getAttribute("flipV")=="1";if(e){u=document.createElement("v:image");u.style.filter="alpha(opacity="+r.alpha+
")";u.style.left=i+"px";u.style.top=h+"px";u.style.width=k+"px";u.style.height=g+"px";u.src=o;if(p&&B)u.style.rotation="180";else if(p)u.style.flip="x";else if(B)u.style.flip="y"}else{u=document.createElementNS(mxConstants.NS_SVG,"image");u.setAttributeNS(mxConstants.NS_XLINK,"xlink:href",o);u.setAttribute("opacity",r.alpha/100);u.setAttribute("x",i);u.setAttribute("y",h);u.setAttribute("width",k);u.setAttribute("height",g);u.setAttribute("preserveAspectRatio","none");if(p||B){var D=1,E=1,o=d=0;if(p){D=
-1;d=-k-2*i}if(B){E=-1;o=-g-2*h}u.setAttribute("transform",l+"scale("+D+" "+E+") translate("+d+" "+o+") ")}else u.setAttribute("transform",l)}c.appendChild(u)}}else if(g=="include-shape"){o=mxStencilRegistry.getStencil(d.getAttribute("name"));if(o!=null){i=s+Number(d.getAttribute("x"))*m;h=t+Number(d.getAttribute("y"))*n;k=Number(d.getAttribute("w"))*m;g=Number(d.getAttribute("h"))*n;o.renderDom(a,new mxRectangle(i,h,k,g),c,r)}}else if(g=="text"){k=this.evaluateAttribute(d,"str",a.state);if(k!=null){i=
y(s+Number(d.getAttribute("x"))*m);h=y(t+Number(d.getAttribute("y"))*n);g=d.getAttribute("align")||"left";o=d.getAttribute("valign")||"top";if(e){u=document.createElement("v:shape");u.style.position="absolute";u.style.width="1px";u.style.height="1px";u.style.left=i+"px";u.style.top=h+"px";d=document.createElement("v:fill");d.color=r.fontColor;d.on="true";u.appendChild(d);d=document.createElement("v:stroke");d.on="false";u.appendChild(d);d=document.createElement("v:path");d.textpathok="true";d.v="m "+
i+" "+h+" l "+(i+1)+" "+h;u.appendChild(d);d=document.createElement("v:textpath");d.style.cssText="v-text-align:"+g;d.style.fontSize=Math.round(r.fontSize/f)+"px";d.style.fontFamily=r.fontFamily;d.string=k;d.on="true";if((r.fontStyle&mxConstants.FONT_BOLD)==mxConstants.FONT_BOLD)d.style.fontWeight="bold";if((r.fontStyle&mxConstants.FONT_ITALIC)==mxConstants.FONT_ITALIC)d.style.fontStyle="italic";if((r.fontStyle&mxConstants.FONT_UNDERLINE)==mxConstants.FONT_UNDERLINE)d.style.textDecoration="underline";
if(o=="top")u.style.top=h+r.fontSize/2+"px";else if(o=="bottom")u.style.top=h-r.fontSize/3+"px";u.appendChild(d)}else{u=document.createElementNS(mxConstants.NS_SVG,"text");u.setAttribute("fill",r.fontColor);u.setAttribute("font-family",r.fontFamily);u.setAttribute("font-size",r.fontSize);u.setAttribute("stroke","none");u.setAttribute("x",i);u.appendChild(document.createTextNode(k));(r.fontStyle&mxConstants.FONT_BOLD)==mxConstants.FONT_BOLD&&u.setAttribute("font-weight","bold");(r.fontStyle&mxConstants.FONT_ITALIC)==
mxConstants.FONT_ITALIC&&u.setAttribute("font-style","italic");(r.fontStyle&mxConstants.FONT_UNDERLINE)==mxConstants.FONT_UNDERLINE&&u.setAttribute("text-decoration",uline);g=="left"?g="start":g=="center"?g="middle":g=="right"&&(g="end");u.setAttribute("text-anchor",g);if(o=="top"){u.setAttribute("y",h+r.fontSize/5);u.setAttribute("dy","1ex")}else if(o=="middle"){u.setAttribute("y",h+r.fontSize/8);u.setAttribute("dy","0.5ex")}else u.setAttribute("y",h);l.length>0&&u.setAttribute("transform",l)}c.appendChild(u)}}else if(h||
i||k){if(u!=null){g=null;if(r.dashed){g=e?v:Number(u.getAttribute("stroke-width"));o=[];for(d=0;d<r.dashpattern.length;d++)o.push(Math.max(1,Math.round(Number(r.dashpattern[d])*g)));g=o.join(" ")}if(i||k)if(e){d=document.createElement("v:stroke");d.endcap=r.linecap||"flat";d.joinstyle=r.linejoin||"miter";d.miterlimit=r.miterlimit||"10";u.appendChild(d);if(g!=null)d.dashstyle=g}else{r.linejoin!=null&&u.setAttribute("stroke-linejoin",r.linejoin);if(r.linecap!=null){d=r.linecap;d=="flat"&&(d="butt");
u.setAttribute("stroke-linecap",d)}r.miterlimit!=null&&u.setAttribute("stroke-miterlimit",r.miterlimit);g!=null&&u.setAttribute("stroke-dasharray",g)}if(q&&a.isShadow){d=mxConstants.SHADOW_OFFSET_X*a.scale;o=mxConstants.SHADOW_OFFSET_Y*a.scale;if(e){p=document.createElement("v:shadow");p.setAttribute("on","true");p.setAttribute("color",mxConstants.SHADOWCOLOR);p.setAttribute("offset",Math.round(d)+"px,"+Math.round(o)+"px");p.setAttribute("opacity",mxConstants.SHADOW_OPACITY*100+"%");d=document.createElement("v:stroke");
d.endcap=r.linecap||"flat";d.joinstyle=r.linejoin||"miter";d.miterlimit=r.miterlimit||"10";if(g!=null)d.dashstyle=g;p.appendChild(d);u.appendChild(p)}else{p=u.cloneNode(true);p.setAttribute("stroke",mxConstants.SHADOWCOLOR);r.fill!=null&&(h||k)?p.setAttribute("fill",mxConstants.SHADOWCOLOR):p.setAttribute("fill","none");p.setAttribute("transform","translate("+d+" "+o+") "+(p.getAttribute("transform")||""));p.setAttribute("opacity",mxConstants.SHADOW_OPACITY);c.appendChild(p)}}if(h)e?u.stroked="false":
u.setAttribute("stroke","none");else if(i)e?u.filled="false":u.setAttribute("fill","none");c.appendChild(u)}q&&(q=false)}else if(g=="linecap")r.linecap=d.getAttribute("cap");else if(g=="linejoin")r.linejoin=d.getAttribute("join");else if(g=="miterlimit")r.miterlimit=d.getAttribute("limit");else if(g=="dashed")r.dashed=d.getAttribute("dashed")=="1";else if(g=="dashpattern"){d=d.getAttribute("pattern");if(d!=null&&d.length>0)r.dashpattern=d.split(" ")}else if(g=="strokewidth"){r.strokeWidth=d.getAttribute("width")*
...
"rect"),d.setAttribute("x",b.x),d.setAttribute("y",b.y),d.setAttribute("width",b.width),d.setAttribute("height",b.height),d.setAttribute("fill","none"),d.setAttribute("stroke","none"),c.appendChild(d));if(null!=this.bgNode)for(d=this.bgNode.firstChild;null!=d;)d.nodeType==mxConstants.NODETYPE_ELEMENT&&C.call(this,d),d=d.nextSibling;else q=!1;if(null!=this.fgNode)for(d=this.fgNode.firstChild;null!=d;)d.nodeType==mxConstants.NODETYPE_ELEMENT&&C.call(this,d),d=d.nextSibling}};
...
c++}return c/2};
mxMedianHybridCrossingReduction.prototype.transpose=function(a,b){for(var c=!0,d=0;c&&10>d++;)for(var e=1==a%2&&1==d%2,c=!1,f=0;f<b.ranks.length;f++){for(var g=b.ranks[f],h=[],i=0;i<g.length;i++){var k=g[i],l=k.getGeneralPurposeVariable(f);0>l&&(l=i);h[l]=k}for(var m=null,n=null,o=null,p=null,q=null,s=null,t=null,v=null,i=0;i<g.length-1;i++){if(0==i){for(var t=h[i],k=t.getNextLayerConnectedCells(f),l=t.getPreviousLayerConnectedCells(f),o=[],p=[],w=0;w<k.length;w++)o[w]=k[w].getGeneralPurposeVariable(f+1);
for(w=0;w<l.length;w++)p[w]=l[w].getGeneralPurposeVariable(f-1)}else k=m,l=n,o=q,p=s,t=v;v=h[i+1];m=v.getNextLayerConnectedCells(f);n=v.getPreviousLayerConnectedCells(f);q=[];s=[];for(w=0;w<m.length;w++)q[w]=m[w].getGeneralPurposeVariable(f+1);for(w=0;w<n.length;w++)s[w]=n[w].getGeneralPurposeVariable(f-1);for(var r=0,u=0,w=0;w<o.length;w++)for(var x=0;x<q.length;x++)o[w]>q[x]&&r++,o[w]<q[x]&&u++;for(w=0;w<p.length;w++)for(x=0;x<s.length;x++)p[w]>s[x]&&r++,p[w]<s[x]&&u++;if(u<r||u==r&&e)m=t.getGeneralPurposeVariable(f),
t.setGeneralPurposeVariable(f,v.getGeneralPurposeVariable(f)),v.setGeneralPurposeVariable(f,m),m=k,n=l,q=o,s=p,v=t,e||(c=!0)}}};mxMedianHybridCrossingReduction.prototype.weightedMedian=function(a,b){var c=0==a%2;if(c)for(var d=b.maxRank-1;0<=d;d--)this.medianRank(d,c);else for(d=1;d<b.maxRank;d++)this.medianRank(d,c)};
...
this.medianXValue(l,i-1),q=m+n,s=e.getGeneralPurposeVariable(i),t=s;0<q&&(t=(o*m+p*n)/q);m=!1;t<s-1?0==k?(e.setGeneralPurposeVariable(i,t),m=!0):(k=d[i][k-1],s=k.getGeneralPurposeVariable(i),s=s+k.width/2+this.intraCellSpacing+e.width/2,s<t?(e.setGeneralPurposeVariable(i,t),m=!0):s<e.getGeneralPurposeVariable(i)-1&&(e.setGeneralPurposeVariable(i,s),m=!0)):t>s+1&&(k==d[i].length-1?(e.setGeneralPurposeVariable(i,t),m=!0):(k=d[i][k+1],s=k.getGeneralPurposeVariable(i),s=s-k.width/2-this.intraCellSpacing-
e.width/2,s>t?(e.setGeneralPurposeVariable(i,t),m=!0):s>e.getGeneralPurposeVariable(i)+1&&(e.setGeneralPurposeVariable(i,s),m=!0)));if(m){for(e=0;e<g.length;e++)i=g[e],i=mxCellPath.create(i.getCoreCell()),i=c[i],null!=i&&!1==i.visited&&(i.visited=!0,b.push(i));for(e=0;e<l.length;e++)i=l[e],i=mxCellPath.create(i.getCoreCell()),i=c[i],null!=i&&!1==i.visited&&(i.visited=!0,b.push(i))}h.visited=!1;f++}};
...
e,s)}finally{if(mxClient.IS_IE)h.overlayPane.innerHTML="";else for(var t=g.firstChild;null!=t;){var v=t.nextSibling,w=t.nodeName.toLowerCase();"svg"==w?(t.setAttribute("width",parseInt(g.style.width)),t.setAttribute("height",parseInt(g.style.height))):"default"!=t.style.cursor&&"table"!=w&&t.parentNode.removeChild(t);t=v}h.overlayPane.parentNode.removeChild(h.overlayPane);this.graph.setEnabled(p);this.graph.container=i;h.canvas=k;h.backgroundPane=l;h.drawPane=m;h.overlayPane=n;h.translate=q;a.destroy();
...
mxConstants.DIRECTION_MASK_SOUTH;h[1]=mxUtils.reversePortConstraints(h[0]);i[1]=mxUtils.reversePortConstraints(i[0]);l=l>=n?l:n;m=k>=m?k:m;n=[[0,0],[0,0]];o=!1;for(k=0;2>k;k++)0==a[k]&&(0==(h[k]&q[k])&&(h[k]=mxUtils.reversePortConstraints(h[k])),0==(i[k]&q[k])&&(i[k]=mxUtils.reversePortConstraints(i[k])),n[k][0]=i[k],n[k][1]=h[k]);m>2*f&&l>2*f&&(0<(h[0]&q[0])&&0<(i[1]&q[1])?(n[0][0]=h[0],n[0][1]=i[0],n[1][0]=i[1],n[1][1]=h[1],o=!0):0<(i[0]&q[0])&&0<(h[1]&q[1])&&(n[0][0]=i[0],n[0][1]=h[0],n[1][0]=
h[1],n[1][1]=i[1],o=!0));m>2*f&&!o&&(n[0][0]=i[0],n[0][1]=h[0],n[1][0]=i[1],n[1][1]=h[1],o=!0);l>2*f&&!o&&(n[0][0]=h[0],n[0][1]=i[0],n[1][0]=h[1],n[1][1]=i[1]);for(k=0;2>k;k++)if(0==a[k]&&(0==(n[k][0]&q[k])&&(n[k][0]=n[k][1]),c[k]=n[k][0]&q[k],c[k]|=(n[k][1]&q[k])<<8,c[k]|=(n[1-k][k]&q[k])<<16,c[k]|=(n[1-k][1-k]&q[k])<<24,0==(c[k]&15)&&(c[k]<<=8),0==(c[k]&3840)&&(c[k]=c[k]&15|c[k]>>8),0==(c[k]&983040)&&(c[k]=c[k]&65535|(c[k]&251658240)>>8),a[k]=c[k]&15,q[k]==mxConstants.DIRECTION_MASK_WEST||q[k]==
mxConstants.DIRECTION_MASK_NORTH||q[k]==mxConstants.DIRECTION_MASK_EAST||q[k]==mxConstants.DIRECTION_MASK_SOUTH))a[k]=q[k];k=a[0]==mxConstants.DIRECTION_MASK_EAST?3:a[0];q=a[1]==mxConstants.DIRECTION_MASK_EAST?3:a[1];k-=g;q-=g;1>k&&(k+=4);1>q&&(q+=4);q=mxEdgeStyle.routePatterns[k-1][q-1];mxEdgeStyle.wayPoints1[0][0]=d[0][0];mxEdgeStyle.wayPoints1[0][1]=d[0][1];switch(a[0]){case mxConstants.DIRECTION_MASK_WEST:mxEdgeStyle.wayPoints1[0][0]-=f;mxEdgeStyle.wayPoints1[0][1]+=b[0][1]*d[0][3];break;case mxConstants.DIRECTION_MASK_SOUTH:mxEdgeStyle.wayPoints1[0][0]+=
...
1];i=0<p%2?0:1;i!=c&&(f++,mxEdgeStyle.wayPoints1[f][0]=mxEdgeStyle.wayPoints1[f-1][0],mxEdgeStyle.wayPoints1[f][1]=mxEdgeStyle.wayPoints1[f-1][1]);var s=0<(q[k]&mxEdgeStyle.TARGET_MASK),o=0<(q[k]&mxEdgeStyle.SOURCE_MASK),m=(q[k]&mxEdgeStyle.SIDE_MASK)>>5,m=m<<g;15<m&&(m>>=4);n=0<(q[k]&mxEdgeStyle.CENTER_MASK);(o||s)&&9>m?(o=o?0:1,p=n&&0==i?d[o][0]+b[o][0]*d[o][2]:n?d[o][1]+b[o][1]*d[o][3]:mxEdgeStyle.limits[o][m],0==i?(m=(p-mxEdgeStyle.wayPoints1[f][0])*l[0],0<m&&(mxEdgeStyle.wayPoints1[f][0]+=l[0]*
...
0<h.length)if(null==g){l=d.addActionCombo(f);for(f=0;f<h.length;f++)m=h[f],"separator"==m.nodeName?d.addOption(l,"---"):"add"==m.nodeName&&(g=m.getAttribute("as"),m=m.getAttribute("action"),d.addActionOption(l,g,m))}else{var q=null,s=d.addPrototype(f,g,function(){var a=e.templates[q.value];if(null!=a){var a=a.clone(),b=q.options[q.selectedIndex].cellStyle;null!=b&&a.setStyle(b);return a}mxLog.warn("Template "+a+" not found");return null},null,null,m),q=d.addCombo();mxEvent.addListener(q,"change",
function(){d.toolbar.selectMode(s,function(a){a=mxUtils.convertPoint(e.graph.container,mxEvent.getClientX(a),mxEvent.getClientY(a));return e.addVertex(null,p(),a.x,a.y)});d.toolbar.noReset=!1});for(f=0;f<h.length;f++)m=h[f],"separator"==m.nodeName?d.addOption(q,"---"):"add"==m.nodeName&&(g=m.getAttribute("as"),n=m.getAttribute("template"),d.addOption(q,g,n||l).cellStyle=m.getAttribute("style"))}null!=o&&(l=c.getAttribute("id"),null!=l&&0<l.length&&o.setAttribute("id",l))}c=c.nextSibling}return d};
...
function EmbedDialog(a){function b(){w.setAttribute("x0",g);w.setAttribute("y0",h);w.setAttribute("pan",k.checked?"1":"0");w.setAttribute("zoom",l.checked?"1":"0");w.setAttribute("resize",m.checked?"1":"0");w.setAttribute("fit",n.checked?"1":"0");w.setAttribute("border",t.value);w.setAttribute("links","1");var a=Base64.encode(RawDeflate.deflate(encodeURIComponent(mxUtils.getXml(w))),!0),b="position:relative;overflow:"+(o.checked?"auto":"hidden")+";";""!=q.value&&(b+="width:"+q.value+"px;");""!=s.value&&
...
mxResources.get("width")+": ");var q=document.createElement("input");q.setAttribute("type","text");q.setAttribute("size","4");q.value=Math.ceil(e.width/f);c.appendChild(q);mxUtils.write(c," "+mxResources.get("height")+": ");var s=document.createElement("input");s.setAttribute("type","text");s.setAttribute("size","4");s.value=Math.ceil(e.height/f);c.appendChild(s);mxUtils.write(c," "+mxResources.get("borderWidth")+": ");var t=document.createElement("input");t.setAttribute("type","text");t.setAttribute("size",
"4");t.value="0";c.appendChild(t);mxUtils.write(c," "+mxResources.get("backgroundColor")+": ");var v=document.createElement("input");v.setAttribute("type","text");v.setAttribute("size","7");v.value=d.background;c.appendChild(v);e=document.createElement("textarea");e.style.width="610px";e.style.height="34px";e.style.resize="none";mxUtils.br(c);mxUtils.write(c,mxResources.get("embedNotice")+": ");c.appendChild(e);for(var w=a.editor.getGraphXml(),f="",r={},d=d.view.states.getValues(),u=0;u<d.length;u++){var x=
mxStencilRegistry.getBasenameForStencil(d[u].style[mxConstants.STYLE_SHAPE]);null!=x&&null==r[x]&&(r[x]=!0,f+=x+";")}0<f.length&&(f="?s="+f.substring(0,f.length-1));e.value='<script type="text/javascript" src="//drawdotio.appspot.com/embed.js'+f+'"><\/script>';b();mxEvent.addListener(k,"change",b);mxEvent.addListener(l,"change",b);mxEvent.addListener(m,"change",b);mxEvent.addListener(n,"change",b);mxEvent.addListener(o,"change",b);mxEvent.addListener(p,"change",b);mxEvent.addListener(q,"change",b);
mxEvent.addListener(s,"change",b);mxEvent.addListener(t,"change",b);mxEvent.addListener(v,"change",b);e=document.createElement("div");e.style.paddingTop="6px";e.style.textAlign="right";e.appendChild(mxUtils.button(mxResources.get("close"),function(){a.hideDialog()}));c.appendChild(e);this.container=c}
...
function ExportDialog(a){function b(){var a=n.value,b=a.lastIndexOf(".");n.value=0<b?a.substring(0,b+1)+o.value:a+"."+o.value;"xml"===o.value?(s.setAttribute("disabled","true"),t.setAttribute("disabled","true"),v.setAttribute("disabled","true")):(s.removeAttribute("disabled"),t.removeAttribute("disabled"),v.removeAttribute("disabled"));"png"===o.value||"svg"===o.value?q.removeAttribute("disabled"):q.setAttribute("disabled","disabled")}function c(){s.style.backgroundColor=s.value>MAX_WIDTH||0>s.value?
"red":"";t.style.backgroundColor=t.value>MAX_HEIGHT||0>t.value?"red":""}function d(){var a=Math.max(0,parseInt(v.value))+1,b=parseInt(s.value)/i,c=f.getGraphBounds(),d=mxUtils.createXmlDocument(),e=null!=d.createElementNS?d.createElementNS(mxConstants.NS_SVG,"svg"):d.createElement("svg");""!=p.value&&(p.value!=mxConstants.NONE&&!q.checked)&&(null!=e.style?e.style.backgroundColor=p.value:e.setAttribute("style","background-color:"+p.value));null==d.createElementNS&&e.setAttribute("xmlns",mxConstants.NS_SVG);
...
l.style.fontSize="10pt";mxUtils.write(l,mxResources.get("width")+":");g.appendChild(l);var s=document.createElement("input");s.setAttribute("value",i);s.style.width="180px";l=document.createElement("td");l.appendChild(s);g.appendChild(l);m.appendChild(g);g=document.createElement("tr");l=document.createElement("td");l.style.fontSize="10pt";mxUtils.write(l,mxResources.get("height")+":");g.appendChild(l);var t=document.createElement("input");t.setAttribute("value",k);t.style.width="180px";l=document.createElement("td");
l.appendChild(t);g.appendChild(l);m.appendChild(g);g=document.createElement("tr");l=document.createElement("td");l.style.fontSize="10pt";mxUtils.write(l,mxResources.get("borderWidth")+":");g.appendChild(l);var v=document.createElement("input");v.setAttribute("value",i);v.style.width="180px";v.value="0";l=document.createElement("td");l.appendChild(v);g.appendChild(l);m.appendChild(g);h.appendChild(m);mxEvent.addListener(o,"change",b);b();mxEvent.addListener(s,"change",function(){t.value=0<i?Math.ceil(parseInt(s.value)*
k/i):"0";c()});mxEvent.addListener(t,"change",function(){s.value=0<k?Math.ceil(parseInt(t.value)*i/k):"0";c()});var w=new mxImageExport,g=document.createElement("tr");l=document.createElement("td");l.colSpan=2;l.style.paddingTop="10px";l.setAttribute("align","right");var r=mxUtils.button(mxResources.get("save"),mxUtils.bind(this,function(){if(0>=parseInt(s.value)&&0>=parseInt(t.value))mxUtils.alert(mxResources.get("drawingEmpty"));else{var b=o.value,c=n.value;if("xml"==b){var g=encodeURIComponent(e());
(new mxXmlRequest(SAVE_URL,"filename="+c+"&xml="+g)).simulate(document,"_blank")}else if("svg"==b)g=d(),g.length<MAX_REQUEST_SIZE?(g=encodeURIComponent(g),(new mxXmlRequest(SAVE_URL,"filename="+c+"&format="+b+"&xml="+g)).simulate(document,"_blank")):(mxUtils.alert(mxResources.get("drawingTooLarge")),mxUtils.popup(g));else{var h=Math.max(0,parseInt(v.value))+1,l=parseInt(s.value)/i,m=f.getGraphBounds(),r=mxUtils.createXmlDocument(),g=r.createElement("output");r.appendChild(g);r=new mxXmlCanvas2D(g);
r.scale(l);r.translate(Math.floor(-m.x*l)+h,Math.floor(-m.y*l)+h);w.drawState(f.getView().getState(f.model.root),r);r=Math.ceil(m.width*l)+2*h;h=Math.ceil(m.height*l)+2*h;g=mxUtils.getXml(g);if(g.length<=MAX_REQUEST_SIZE&&i<MAX_WIDTH&&0<i&&k<MAX_HEIGHT&&0<k){l="";if(""!=p.value&&p.value!=mxConstants.NONE&&("png"!=b||!q.checked))l="&bg="+p.value;(new mxXmlRequest(EXPORT_URL,"filename="+c+"&format="+b+l+"&w="+r+"&h="+h+"&plain="+encodeURIComponent(g))).simulate(document,"_blank")}else mxUtils.alert(mxResources.get("drawingTooLarge"))}a.hideDialog()}}));
l.appendChild(r);l.appendChild(mxUtils.button(mxResources.get("cancel"),function(){a.hideDialog()}));g.appendChild(l);m.appendChild(g);var u=null;mxEvent.addListener(o,"change",function(){var b=o.value;"xml"==b?null==u?u=a.replaceSaveButton(r,e,mxUtils.bind(this,function(){return n.value}),mxUtils.bind(this,function(){a.hideDialog()})):null!=u&&"none"==u.style.display&&(u.style.display="inline"):"svg"==b?null==u?u=a.replaceSaveButton(r,d,mxUtils.bind(this,function(){return n.value}),mxUtils.bind(this,
function(){a.hideDialog()})):null!=u&&"none"==u.style.display&&(u.style.display="inline"):null!=u&&"none"!=u.style.display&&(u.style.display="none")});m.appendChild(g);h.appendChild(m);this.container=h}
...
var y=this;if(driveDomain){a=document.createElement("div");a.style.padding="4px 12px 5px 10px";a.style.cssFloat="right";a.style.styleFloat="right";c=document.createElement("span");c.style.display="none";c.style.cssFloat="left";c.style.styleFloat="left";c.style.padding="0px 8px 5px 10px";c.style.fontStyle="italic";d=document.createElement("a");d.className="geItem";d.style.cssFloat="left";d.style.styleFloat="left";d.style.display="none";d.style.padding="0px 12px 5px 10px";d.href="javascript:void(0);";
d.innerHTML=mxResources.get("signOut","Sign Out");mxEvent.addListener(d,"mouseup",function(){y.userInfo.isLogout=true;window.location.href="http://drive.google.com"});var C=document.createElement("div");C.style.clear="both";a.appendChild(c);a.appendChild(d);a.appendChild(C);y.menubar.container.appendChild(a);y.userInfo=y.userInfo||{};y.userInfo.emailEl=c;y.userInfo.logoutEl=d;setInterval(function(){y.checkSession()},1E3)}};EditorUi.prototype.getUrl=function(a){var a=null!=a?a:window.location.pathname,
b=0<a.indexOf("?")?1:0,c;for(c in urlParams)"tmp"!=c&&("libs"!=c&&"state"!=c&&"fileId"!=c&&"code"!=c&&"share"!=c&&"url"!=c)&&(a=0==b?a+"?":a+"&",a+=c+"="+urlParams[c],b++);return a};var k=EditorUi.prototype.open;EditorUi.prototype.open=function(){var b=!1;try{b=!(null==window.opener||null==window.opener.openFile)}catch(c){}driveDomain&&(this.editor.googleFile={title:"untitled.html",content:"",mimeType:"application/mxe",description:""});if(b)k.apply(this,arguments);else{var b=urlParams.share,d=urlParams.url;
...
a.stopPropagation();a.cancelBubble=true});mxEvent.addListener(f,"selectstart",function(a){a.stopPropagation&&a.stopPropagation();a.cancelBubble=true});this.addFoldingHandler(b,c,function(){},!1);g=document.createElement("div");g.appendChild(c);this.container.appendChild(g);this.palettes.images=[b,g]};var m=Menus.prototype.init;Menus.prototype.init=function(){m.apply(this,arguments);var a=this.editorUi.editor.graph,b=this.editorUi;this.put("moreShapes",new Menu(mxUtils.bind(this,function(a,b){var c=
...
b)}mxResources.parse("snapshot=Snapshot");mxResources.parse("debug=Debug");this.editorUi.actions.addAction("snapshot",mxUtils.bind(this,function(){this.editorUi.sharing!=null&&console.log(this.editorUi.sharing.doc)}));this.editorUi.actions.addAction("debug",mxUtils.bind(this,function(){if(this.editorUi.sharing!=null){this.editorUi.sharing.logging=!this.editorUi.sharing.logging;this.editorUi.sharing.logging&&mxLog.show();mxLog.debug("Debugging "+(this.editorUi.sharing.logging?"enabled":"disabled"))}else mxLog.debug("Document not shared")}));
...
620,420,true,true)}));this.put("file",new Menu(mxUtils.bind(this,function(a,b){this.addSubmenu("new",a,b);this.addMenuItems(a,["open","-","save","saveAs","-","export","share","embed","-","import","editFile","-","pageSetup","print"],b)})))};EditorUi.prototype.replaceSaveButton=function(a,b,c,d){var e=null,f=window;f.URL=f.webkitURL||f.URL;f.BlobBuilder=f.BlobBuilder||f.WebKitBlobBuilder||f.MozBlobBuilder;"undefined"!=typeof swfobject&&(swfobject.hasFlashPlayerVersion("10")&&"undefined"!=typeof Downloadify)&&
(e=document.createElement("span"),a.parentNode.insertBefore(e,a),Downloadify.create(e,{data:b,filename:c,onComplete:d,onCancel:function(){},onError:function(){},swf:"js/downloadify/downloadify.swf",downloadImage:"js/downloadify/transparent.png",width:a.offsetWidth+2,height:a.offsetHeight+2,transparent:!0,append:!0}),b="-6px",mxClient.IS_IE&&9==document.documentMode?b="-7px":mxClient.IS_IE&&(b="-3px"),e.style.display="inline",e.style.position="absolute",e.style.left=a.offsetLeft+20+"px",e.style.height=
a.offsetHeight+2+"px",e.style.width=a.offsetWidth+2+"px",e.firstChild.style.marginBottom=b,mxEvent.addListener(e,"mouseover",function(){a.focus()}),mxEvent.addListener(e,"mouseout",function(){a.blur()}));return e};useLocalStorage||(EditorUi.prototype.saveFile=function(a){!a&&null!=this.editor.filename?this.save(this.editor.getOrCreateFilename()):this.showDialog((new SaveDialog(this)).container,300,driveDomain?150:80,!0,!0);if(null!=this.dialog){var a=mxUtils.bind(this,function(a){for(var a=document.getElementsByTagName(a),
b=0;b<a.length;b++)for(var c=a[b].parentNode;null!=c;){if(c==this.dialog.container)return a[b];c=c.parentNode}return null}),b=a("input"),a=a("button");null!=b&&null!=a&&this.replaceSaveButton(a,mxUtils.bind(this,function(){return mxUtils.getXml(this.editor.getGraphXml())}),mxUtils.bind(this,function(){return b.value}),mxUtils.bind(this,function(){this.editor.filename=b.value;this.editor.modified=!1;this.hideDialog()}))}});var n=Graph.prototype.loadStylesheet;Graph.prototype.loadStylesheet=function(){n.apply(this,
arguments);this.currentStyle="default-style2"};var o=Editor.prototype.setGraphXml;Editor.prototype.setGraphXml=function(a){if(a.nodeName=="mxGraphModel"){var b=a.getAttribute("style");if(b==null||b==""){var c=mxUtils.load(STYLE_PATH+"/default-old.xml").getDocumentElement(),d=new mxCodec(c.ownerDocument);d.decode(c,this.graph.getStylesheet())}else if(b!=this.graph.currentStyle){c=mxUtils.load(STYLE_PATH+"/"+b+".xml").getDocumentElement();d=new mxCodec(c.ownerDocument);d.decode(c,this.graph.getStylesheet());
this.graph.currentStyle=b}this.graph.currentStyle=b}o.apply(this,arguments)};var p=Editor.prototype.getGraphXml;Editor.prototype.getGraphXml=function(){var a=p.apply(this,arguments);this.graph.currentStyle!=null&&a.setAttribute("style",this.graph.currentStyle);return a};driveDomain&&(EditorUi.prototype.setUserInfo=function(a,b){var c=this;c.userInfo=c.userInfo||{};c.userInfo.id=b;c.userInfo.email=a;c.userInfo.loggedOut=false;c.userInfo.emailEl.style.display="inline";c.userInfo.logoutEl.style.display=
"inline";c.userInfo.emailEl.innerHTML=a;window.onunload=function(){if(c.userInfo.isLogout){document.cookie.split(";");c.getUserIdFromCookie()==c.userInfo.id&&c.clearCookies()}}},EditorUi.prototype.getUserIdFromCookie=function(){for(var a=document.cookie.split(";"),b=null,c=0;c<a.length;c++){var d=a[c];d.indexOf("drive")!=-1&&(b=d.split("=")[1])}return b},EditorUi.prototype.checkSession=function(){var a=this.getUserIdFromCookie();if(!(typeof this.userInfo.id==="undefined"||this.userInfo.loggedOut===
"undefined"))if(this.userInfo.id!=null&&this.userInfo.id!=a&&!this.userInfo.loggedOut||a==null&&!this.userInfo.loggedOut){this.userInfo.loggedOut=true;this.userInfo.emailEl.style.display="none";this.userInfo.logoutEl.style.display="none";this.showDialog((new LogoutPopup(this)).container,320,80,true,true)}},EditorUi.prototype.clearCookies=function(){for(var a=document.cookie.split(";"),b=0;b<a.length;b++){var c=a[b],d=c.indexOf("="),c=d>-1?c.substr(0,d):c;document.cookie=c+"=;expires=Thu, 01 Jan 1970 00:00:00 GMT"}},
LogoutPopup=function(a){var b=document.createElement("div");b.setAttribute("align","center");mxUtils.write(b,mxResources.get("userLoggedOut")+" "+a.userInfo.email);mxUtils.br(b);mxUtils.br(b);b.appendChild(mxUtils.button(mxResources.get("close"),function(){a.hideDialog()}));this.container=b})})();(function(a,b){a.version="0.8.7";a.protocol=1;a.transports=[];a.j=[];a.sockets={};a.connect=function(c,d){var e=a.util.parseUri(c),f,g;b&&b.location&&(e.protocol=e.protocol||b.location.protocol.slice(0,-1),e.host=e.host||(b.document?b.document.domain:b.location.hostname),e.port=e.port||b.location.port);f=a.util.uniqueUri(e);var h={host:e.host,secure:"https"==e.protocol,port:e.port||("https"==e.protocol?443:80),query:e.query||""};a.util.merge(h,d);if(h["force new connection"]||!a.sockets[f])g=new a.Socket(h);
...
s(function(a,c){return a?b(a):b(null,this.makeDoc(c))},this))};a.prototype.open=function(a,b,c){if(this.socket===null)c("connection closed");else{if(typeof b==="function"){c=b;b="text"}c||(c=function(){});typeof b==="string"&&(b=q[b]);if(!b)throw Error("OT code for document type missing");if(a!=null&&this.docs[a]!=null){a=this.docs[a];a.type===b?c(null,a):c("Type mismatch",a)}else return this.send({doc:a,open:true,create:true,snapshot:null,type:b.name},s(function(a,d){if(a)return c(a);if(d.snapshot===
...
b.length-1);if(0===b.length)return-1;for(c=0;a[c]===b[c]&&c<a.length;)if(c++,c===b.length)return c-1};f.transformComponent=function(a,c,d,e){var g,i,k,t,v,c=b(c);void 0!==c.na&&c.p.push(0);void 0!==d.na&&d.p.push(0);g=f.commonPath(c.p,d.p);i=f.commonPath(d.p,c.p);t=c.p.length;k=d.p.length;void 0!==c.na&&c.p.pop();void 0!==d.na&&d.p.pop();if(d.na)return null!=i&&(k>=t&&d.p[i]===c.p[i])&&(void 0!==c.ld?(i=b(d),i.p=i.p.slice(t),c.ld=f.apply(b(c.ld),[i])):void 0!==c.od&&(i=b(d),i.p=i.p.slice(t),c.od=
f.apply(b(c.od),[i]))),f.append(a,c),a;null!=i&&(k>t&&c.p[i]===d.p[i])&&(void 0!==c.ld?(i=b(d),i.p=i.p.slice(t),c.ld=f.apply(b(c.ld),[i])):void 0!==c.od&&(i=b(d),i.p=i.p.slice(t),c.od=f.apply(b(c.od),[i])));if(null!=g&&(i=t===k,void 0===d.na))if(void 0!==d.si||void 0!==d.sd){if(void 0!==c.si||void 0!==c.sd){if(!i)throw Error("must be a string?");k=function(a){var b;b={p:a.p[a.p.length-1]};a.si?b.i=a.si:b.d=a.sd;return b};t=k(c);k=k(d);d=[];h._tc(d,t,k,e);k=0;for(i=d.length;k<i;k++)t=d[k],e={p:c.p.slice(0,
g)},e.p.push(t.p),null!=t.i&&(e.si=t.i),null!=t.d&&(e.sd=t.d),f.append(a,e);return a}}else if(void 0!==d.li&&void 0!==d.ld){if(d.p[g]===c.p[g])if(i){if(void 0!==c.ld)if(void 0!==c.li&&"left"===e)c.ld=b(d.li);else return a}else return a}else if(void 0!==d.li)void 0!==c.li&&void 0===c.ld&&i&&c.p[g]===d.p[g]?"right"===e&&c.p[g]++:d.p[g]<=c.p[g]&&c.p[g]++,void 0!==c.lm&&i&&d.p[g]<=c.lm&&c.lm++;else if(void 0!==d.ld){if(void 0!==c.lm&&i){if(d.p[g]===c.p[g])return a;e=d.p[g];i=c.p[g];v=c.lm;(e<v||e===v&&
i<v)&&c.lm--}if(d.p[g]<c.p[g])c.p[g]--;else if(d.p[g]===c.p[g]){if(k<t)return a;if(void 0!==c.ld)if(void 0!==c.li)delete c.ld;else return a}}else if(void 0!==d.lm)if(void 0!==c.lm&&t===k){if(i=c.p[g],v=c.lm,t=d.p[g],d=d.lm,t!==d)if(i===t)if("left"===e)c.p[g]=d,i===v&&(c.lm=d);else return a;else i>t&&c.p[g]--,i>d?c.p[g]++:i===d&&t>d&&(c.p[g]++,i===v&&c.lm++),v>t?c.lm--:v===t&&v>i&&c.lm--,v>d?c.lm++:v===d&&(d>t&&v>i||d<t&&v<i?"right"===e&&c.lm++:v>i?c.lm++:v===t&&c.lm--)}else void 0!==c.li&&void 0===
...
f){if(h.length===i.length)throw Error("paths match length and have commonality, but aren't equal?");d=b.p.slice(e+1);return c(d,b)}}.call(this));return v}.call(this));return r})}}}).call(this);